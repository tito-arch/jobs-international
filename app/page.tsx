    ...
    <div className="flex min-h-screen flex-col">
      <HomeLayout>
        <div className="flex-1 ">
          <section className="relative bg-gradient-to-br from-pink-300 via-purple-300 to-blue-300 my-16 md:my-24 overflow-hidden min-h-[600px]">
            <div className="container mx-auto px-4 text-center relative z-10">
              <div className="max-w-3xl mx-auto">
                {/* <div className="flex flex-col md:flex-row gap-2 p-2 bg-white rounded-lg shadow-md">
                  ...
                  <Button className="w-full md:w-auto bg-gradient-to-r from-pink-500 to-purple-600 text-white cursor-pointer">
                    Search
                  </Button>
                </div> */}
              </div>
            ...
            <div className="absolute inset-0 bg-white">
              <div className="h-full flex justify-center">
                <div className="relative w-[90%] h-full rounded-t-lg overflow-hidden">
                  <Image
          ...
          <section className="py-16">
            <div className="container mx-auto px-4 text-center">
              ...
              <Link href="/popular-jobs">
                <Button
                  variant="outline"
                  className="bg-gradient-to-r from-pink-500 to-purple-600 text-white cursor-pointer mt-4"
                >
          ...
          <section
            id="about-us"
            className="py-16 bg-gradient-to-br from-white to-pink-50"
          >
            <div className="container mx-auto px-4">
              <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-8">
                  ...
                  <span className="text-pink-500">Opportunity</span>
                </h2>
                <div className="space-y-4 text-gray-700 mb-12">
                  <p>
                    At Jobs International, we connect talented professionals
                    with dynamic companies worldwide.
                  </p>
                  <p>
                    Our recruitment agency provides tailored staffing solutions
                    that drive success for both job seekers and employers.
                  </p>
                </div>

                {/* Stepper */}
                <div className="relative flex flex-col md:flex-row items-center justify-between w-full max-w-4xl">
                  {/* Line */}
                  <div className="absolute hidden md:block top-6 left-6 right-6 h-0.5 bg-pink-200 z-0" />

                  {/* Steps */}
                  <div className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-0 w-full">
                    {/* Step 1 */}
                    <div className="flex flex-col items-center w-1/3 px-4">
                      <div className="flex items-center justify-center w-12 h-12 rounded-full bg-pink-100 text-pink-500 font-bold text-lg mb-2">
                        1
                      </div>
                    ...
                    <div className="flex flex-col items-center w-1/3 px-4">
                      ...
                      <p className="text-gray-600 text-sm">
                        We find candidates who are qualified and fit the
                    ...
                    <div className="flex flex-col items-center w-1/3 px-4">
                      ...
                      <p className="text-gray-600 text-sm">
                        Connect with opportunities and talent from around the
                        world.
                      </p>
                    </div>
                  </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="text-center mb-12">
                ...
                <p className="max-w-2xl mx-auto">
                  The principles that guide everything we do at Jobs
                  International
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="bg-white/10 backdrop-blur-sm border-0 shadow-lg hover:bg-white/20 transition-all p-6 text-center">
                  ...
                  <p className="text-white/80">
                    We operate with transparency and honesty in everything we
                    do.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border-0 shadow-lg hover:bg-white/20 transition-all p-6 text-center">
                  ...
                  <p className="text-white/80">
                    We strive to exceed expectations by offering outstanding
                    service.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border-0 shadow-lg hover:bg-white/20 transition-all p-6 text-center">
                  ...
                  <p className="text-white/80">
                    We believe in the power of working together to achieve
                    mutual success.
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border-0 shadow-lg hover:bg-white/20 transition-all p-6 text-center">
                  ...
                  <p className="text-white/80">
                    We embrace creative solutions to meet evolving needs of
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <p className="max-w-2xl mx-auto text-gray-600">
                  Expert tips to help you stand out and make the most of your
                  job search
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-r from-pink-50 to-purple-50 p-6 rounded-xl border border-pink-100">
                    ...
                    <p className="text-gray-700">
                      Assess your skills and values to target roles that align
                  ...
                  <div className="bg-gradient-to-r from-pink-50 to-purple-50 p-6 rounded-xl border border-pink-100">
                    ...
                    <p className="text-gray-700">
                      Build meaningful connections that can open doors to hidden
                      opportunities.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="border border-pink-100 hover:shadow-md transition-all p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Research the company and practice common interview
                    questions.
                  </p>
                </div>
                <div className="border border-pink-100 hover:shadow-md transition-all p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Keep refining your approach and don&apos;t be discouraged by
                    setbacks.
                  </p>
                </div>
                <div className="border border-pink-100 hover:shadow-md transition-all p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Explore new roles that may offer exciting growth potential.
                  </p>
                </div>
                <div className="border border-pink-100 hover:shadow-md transition-all p-6">
                  <div className="bg-pink-100 text-pink-600 w-10 h-10 rounded-full flex items-center justify-center mb-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Invest in upskilling to enhance your qualifications.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-16 bg-gradient-to-br from-pink-400 via-purple-400 to-blue-400 text-white">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="max-w-2xl mx-auto mb-8 text-lg">
                ...
                career match with Jobs International
              </p>
